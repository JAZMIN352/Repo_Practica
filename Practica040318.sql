...
--Crea tablas customer, location, account
...
customer_id NUMBER NOT NULL CONSTRAINT customer_id REFERENCES CUSTOMERS(id),
location_id NUMBER NOT NULL CONSTRAINT location_id REFERENCES LOCATIONS(id)
...
--(customer_id NUMBER NOT NULL CONSTRAINT customer_id REFERENCES CUSTOMERS(id),
--location_id NUMBER NOT NULL CONSTRAINT location_id REFERENCES CUSTOMERS(id)
--);
